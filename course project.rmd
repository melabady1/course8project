...
```
as we can see the accurace is more than 100% and the error rate is 0% with using cross validation.
...
```
as we can see the accurace is more than 99.85% on validation set and the error rate is 0.15%.
